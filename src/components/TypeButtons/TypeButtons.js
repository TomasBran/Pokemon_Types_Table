    ...
    const searchPokemon = (selectedPokemon) => {
        fetch('https://pokeapi.co/api/v2/pokemon/' + selectedPokemon.toLowerCase())
            ...
            .catch(() =>{
                ...
                deleteBothTypes()
                resetTypes()
                alert(`El pokemon "${input.toUpperCase()}" no existe (cambiar x toastify)`)
            })
    ...
    return (
        <div className="flexContainer">
            ...
            <div className="selectorContainer">
                ...
                <div className={`pokedexContainer ${currentFirstSelection!=="" ? currentFirstSelection : currentSecondSelection} ${(currentFirstSelection==="" && currentSecondSelection==="") && "emptyPokedex"}`}>
